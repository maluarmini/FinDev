    ...
    return (
        ...
        <MapView onRegionChangeComplete={handleRegionChange} initialRegion={currentRegion} style={styles.map}>
            ...
            {devs.map(dev => (
                ...
                <Callout onPress={() => {
                    navigation.navigate('Perfil no Github', { github_username: dev.github_username });
                }}>
        ...
        <View style={styles.searchForm}>
            <TextInput style={styles.searchInput} placeholder="Buscar devs por tecnologias" placeholderTextColor="#999" autoCapitalize="words" autoCorrect={false} value={techs} onChangeText={setTechs}></TextInput>
